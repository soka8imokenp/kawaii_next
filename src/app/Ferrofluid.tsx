...
const Ferrofluid = ({
  ...
  // 1. WebGL Initialization (Runs only once on mount or when dpr/paused changes)
  useEffect(() => {
  ...
  // 2. Uniform Updates (Runs when props change, extremely lightweight and prevents WebGL context recreation)
  useEffect(() => {
